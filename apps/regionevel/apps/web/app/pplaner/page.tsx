...
export default function PplanerBridgePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0f17] text-white flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="max-w-md w-full bg-slate-900/60 border border-slate-800 backdrop-blur-xl rounded-3xl p-8 text-center shadow-2xl relative z-10 animate-in fade-in zoom-in-95 duration-500">
        ...
        <p className="text-slate-400 text-sm font-medium leading-relaxed mb-6">
          ...
          현재 보고 계신 <strong>Regionevel</strong>과 <strong>JapanRailNote</strong>의 데이터가 유기적으로 연동되어 더욱 깊이 있는 여행 지도를 만들어 드립니다.
        </p>

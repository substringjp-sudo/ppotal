...
export const metadata = {
  title: "About Regionevel — 나의 국내 및 해외 여행 경현치 지도 만들기",
  description: "Regionevel 서비스 소개: 대한민국 시군구 및 글로벌 여행 지도를 한눈에 기록하는 글로벌 여행 레벨 트래커입니다.",
};
  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen bg-slate-50">
      ...
      <section className="py-20 px-4 text-center bg-slate-50 w-full border-t border-gray-100">
        ...
        <Link
          href="/"
          className="px-10 py-4 bg-slate-900 text-white font-black text-xl hover:bg-slate-800 transition-all inline-block shadow-lg rounded-2xl"
        >
          Open World Map
        </Link>
      </section>

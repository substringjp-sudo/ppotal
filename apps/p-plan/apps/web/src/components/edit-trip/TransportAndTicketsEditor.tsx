            ...
            <section className="space-y-8">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-slate-200 dark:border-slate-800 pb-4 gap-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-slate-900 dark:text-white">항공편</h3>
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-tight">출국, 귀국 및 기타 비행 일정을 관리합니다.</p>
                        </div>
                    </div>
                </div>
            ...
            <section className="space-y-8">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-slate-200 dark:border-slate-800 pb-4 gap-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-slate-900 dark:text-white">드라이브 / 렌터카</h3>
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-tight">직접 운전하거나 차량을 렌트하는 일정을 관리합니다.</p>
                        </div>
                    </div>
                </div>
            ...
            <section className="space-y-8">
                <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold text-slate-900 dark:text-white">대중교통 (예약 필요)</h3>
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-tight">버스, 기차, 페리 등 미리 예약이 필요한 대중교통을 관리합니다.</p>
                        </div>
                    </div>
                </div>
                <PublicTransportList />

...
export default function SmartInsightHub() {
    ...
    return (
        <div className="h-full flex flex-col gap-3">
            {/* Smart Voice Section */}
            <div className="flex-1 p-6 rounded-[20px] bg-slate-900 dark:bg-white text-white dark:text-slate-900 border border-slate-800 dark:border-slate-200 shadow-xl relative overflow-hidden group">
                {/* Background Decor */}
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-xs font-semibold uppercase tracking-widest opacity-60">스마트 통찰 및 상태</span>
                    </div>

                    <h3 className="text-xl font-bold mb-2 tracking-tight italic leading-tight">

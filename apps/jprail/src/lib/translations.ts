...
export const MY_LINES_TRANSLATIONS = {
    ko: {
        ...
        addVia: '경유역 추가',
        searchRoute: '경로 탐색',
        tooManyCandidatesWarning: '경우의 수가 5개 이상 발견되었습니다. 경유역을 추가하면 더 정확한 경로를 지정할 수 있습니다.',
        selectRoute: '이 경로 선택',
    ...
    en: {
        ...
        tooManyCandidatesWarning: '5 or more candidate routes found. Adding a via station can help narrow down the exact route.',
    ...
    ja: {
        ...
        addVia: '経由駅追加',
        searchRoute: '経路検索',
        tooManyCandidatesWarning: '5件以上の経路候補が見つかりました。経由駅を追加して経路を絞り込んでください。',
        selectRoute: 'この経路を選択',

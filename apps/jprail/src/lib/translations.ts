...
export const MY_LINES_TRANSLATIONS = {
    ko: {
        ...
        endStation: '도착역',
        addVia: '경유역 추가',
        excludeWalk: '도보 환승 제외',
        excludeWalkHint: '선로로만 이어지는 경로를 찾습니다. 길이 아예 없을 수도 있습니다.',
        searchRoute: '경로 탐색',
        ...
        // --- 탑승 내역 편집 ---
        editTrip: '탑승 내역 편집',
        editTripSubtitle: '끝점·방향·날짜를 고치고, 중간 경로를 골라 보세요',
        tripName: '이름',
        tripNamePlaceholder: '예) 첫 홋카이도',
        rideDate: '탄 날',
        rideDateUnknown: '모름',
        clearDate: '날짜 지우기',
        direction: '방향',
        swapEnds: '시작과 종료 맞바꾸기',
        endpoints: '시작역과 종료역',
        shrink: '한 역 줄이기',
        grow: '한 역 늘리기',
        cannotShrink: '더 줄일 수 없습니다',
        noNeighbour: '이어진 역이 없습니다',
        changeStation: '다른 역으로',
        middleRoutes: '중간 경로',
        middleRoutesHint: '같은 두 역 사이에도 길이 여럿입니다. 실제로 탄 길을 고르세요.',
        onlyOneRoute: '이 두 역 사이에는 길이 하나뿐입니다.',
        searchingRoutes: '경로를 찾는 중…',
        routeNotFound: '이 두 역을 잇는 길을 찾지 못했습니다. 되돌리거나 다른 역을 고르세요.',
        transferCount: (n: number) => `환승 ${n}회`,
        walkCountLabel: (n: number) => `도보 ${n}회`,
        saveTrip: '저장',
        cancelEdit: '취소',
        revertEdit: '되돌리기',
        unsavedHint: '고친 내용이 아직 저장되지 않았습니다',
        badgeRecommended: '추천',
        badgeShortest: '최단거리',
    ...
    en: {
        ...
        riddenOn: 'Date ridden',
        recordedOn: 'Date recorded (the ride date is unknown)',
        ...
        excludeWalk: 'No walking transfers',
        excludeWalkHint: 'Rails only. Some places then have no route at all.',
        ...
        // --- Trip editing ---
        editTrip: 'Edit trip',
        editTripSubtitle: 'Move the ends, flip the direction, set the date, pick the route',
        tripName: 'Name',
        tripNamePlaceholder: 'e.g. First trip to Hokkaido',
        rideDate: 'Date ridden',
        rideDateUnknown: 'Unknown',
        clearDate: 'Clear date',
        direction: 'Direction',
        swapEnds: 'Swap start and end',
        endpoints: 'Start and end',
        shrink: 'One stop in',
        grow: 'One stop out',
        cannotShrink: 'Cannot shrink further',
        noNeighbour: 'No station beyond this one',
        changeStation: 'Pick another station',
        middleRoutes: 'Route taken',
        middleRoutesHint: 'There is more than one way between these two stations. Pick the one you rode.',
        onlyOneRoute: 'Only one route connects these two stations.',
        searchingRoutes: 'Finding routes…',
        routeNotFound: 'No route connects these two stations. Revert, or pick different ones.',
        transferCount: (n: number) => `${n} transfer${n === 1 ? '' : 's'}`,
        walkCountLabel: (n: number) => `${n} walk${n === 1 ? '' : 's'}`,
        saveTrip: 'Save',
        cancelEdit: 'Cancel',
        revertEdit: 'Revert',
    ...
    ja: {
        ...
        addVia: '経由駅追加',
        excludeWalk: '徒歩乗換なし',
        excludeWalkHint: '線路だけでつなぎます。経路が無いこともあります。',
        searchRoute: '経路検索',
        ...
        // --- 乗車記録の編集 ---
        editTrip: '乗車記録の編集',
        editTripSubtitle: '端の駅・向き・日付を直し、経路を選べます',
        tripName: '名前',
        tripNamePlaceholder: '例）初めての北海道',
        rideDate: '乗った日',
        rideDateUnknown: '不明',
        clearDate: '日付を消す',
        direction: '向き',
        swapEnds: '始点と終点を入れ替える',
        endpoints: '始点と終点',
        shrink: '一駅縮める',
        grow: '一駅伸ばす',
        cannotShrink: 'これ以上縮められません',
        noNeighbour: 'この先に駅がありません',
        changeStation: '別の駅にする',
        middleRoutes: '通った経路',
        middleRoutesHint: '同じ二駅の間にも道は複数あります。実際に乗った道を選んでください。',
        onlyOneRoute: 'この二駅を結ぶ道は一つだけです。',
        searchingRoutes: '経路を探しています…',
        routeNotFound: 'この二駅を結ぶ道が見つかりません。元に戻すか、別の駅を選んでください。',
        transferCount: (n: number) => `乗換 ${n}回`,
        walkCountLabel: (n: number) => `徒歩 ${n}回`,
        saveTrip: '保存',
        cancelEdit: 'やめる',
        revertEdit: '元に戻す',
        unsavedHint: '変更がまだ保存されていません',

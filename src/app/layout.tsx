...
export const metadata: Metadata = {
  metadataBase: new URL('https://jprail.pplaner.com'),
  title: "JapanRailNote | Interactive Japan Railway Map & Travel Tracker | 日本鉄道マップ & 乗りつぶ시 기록 | 일본 철도 지도 & 여행 기록",
  ...
  keywords: [
    ...
    "Tokaido Shinkansen", "Yamanote Line", "Tokyo Station", "Shinkansen Station", "Osaka Station",
    "Railway Route Map Japan", "Subway Map Tokyo", "Subway Map Osaka", "Train Route Finder Japan"
  ],
  openGraph: {
    title: "JapanRailNote | Japan Railway Map & Travel Tracker | 日本鉄道マップ & 乗りつぶし 기록 | 일본 철도 지도 & 여행 기록",
